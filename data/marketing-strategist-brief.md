# Marketing Strategist, Intelligence Brief

> Phase B, Archetype Intelligence Brief | Marketing Domain | B2B SaaS, 50-500 employees
...
A good week is a launch campaign that creates pipeline in its first 48 hours, a rep who walks into a Competitor A competitive deal having actually opened the battlecard, and a renewal conversation where the message the Marketing Strategist seeded in onboarding is the reason the customer stayed. A difficult week is discovering that the sales team is still using a positioning frame that lost 70% of deals last quarter, or that the competitor who raised a $40M Series B two weeks ago hasn't appeared in a single internal update.

The Marketing Strategist operates at the intersection of what the market believes and what the sales team says. Their data is messier than a CRO's pipeline report because it lives in Gong transcripts, close-reason fields AEs may not fill out, battlecard adoption analytics, and PR coverage spreadsheets. Lens's job for this archetype is to surface the signal in that messy data before they have to go looking.

## 2. Real roles that map to this archetype

**Core titles:**
- Product Marketing Manager (PMM) / Senior PMM / Principal PMM
- Director of Product Marketing / VP of Product Marketing
- GTM Strategist / Head of Go-to-Market
- Competitive Intelligence Manager / Director of CI
- Market Intelligence Analyst (where this role owns battlecards and messaging)
- Portfolio Marketing Manager (multi-product PMMs at scale)

**Edge cases that fit:**
- Brand Strategist at companies where brand carries the positioning accountability
- Growth Marketer who owns the ICP definition and positioning experiments
- Marketing Director at smaller companies where one person covers strategy + enablement

**Titles that sound similar but don't fit:**
- Marketing Leader (VP/CMO altitude, owns the full marketing org): the Marketing Strategist reports to this person
...
**Communities:**
- Product Marketing Alliance (PMA) Slack, 26,000+ PMM practitioners
- PMM Hive, private community for senior product marketers
- Sharebird (public PMM Q&A and peer answers to positioning/launch questions)
- Pavilion GTM track for VP-level
- Competitive Intelligence Alliance community

**Benchmark reports they cite:**
- Product Marketing Alliance: State of Product Marketing (annual, covers ICP confidence, launch process maturity, battlecard adoption)
- Crayon / Klue State of Competitive Intelligence (annual, CI function maturity, competitive program ROI)
- Forrester and Gartner for category placement and analyst coverage tracking
- G2 category momentum reports (user reviews, competitive share of voice)
- Crossbeam partner ecosystem reports (when positioning intersects partnership strategy)
...
**3. Launch pipeline attribution is always contested.**
When a product launch generates 20 new opportunities, Marketing Strategist wants to show the launch created them. Revenue wants to know if the opportunities would have happened anyway. The attribution methodology is contested, the deal records often don't have the launch-attributed flag, and Finance wants conservative credit. *Cross-functional friction: with Revenue Leader on pipeline attribution methodology.*

**4. Competitive blindspots appear in the quarter they matter.**
A competitor raises a round in January, announces two major product updates in February and March, and the Marketing Strategist learns about it in April when reps start losing deals they weren't expecting to lose. The signal was in the public domain; the problem was no one was watching it systematically. *Goal-pursuit friction: competitive readiness.*

**5. Discovery call message resonance is anecdotal.**
"Our new 'speed-to-value' positioning is landing well" is a statement the Marketing Strategist can't prove or disprove without systematic analysis of Gong transcripts. Most PMMs have a narrative about what's working in the market that is built on a handful of calls they personally listened to, not a statistical sample. *Goal-pursuit friction: messaging confidence and ICP match.*

**6. Launch readiness is always behind.**
The Marketing Strategist is the person ensuring that positioning, battlecards, and sales briefings are ready before a product ships. In practice, engineering ships when it ships, and PMM is the function scrambling to finish the launch brief two days before the announcement. *Goal-pursuit friction: launch execution quality.*
...
**Quote 1:** "What are we losing to Competitor A that we weren't losing to them last quarter?"
...
**Quote 5:** "What are customers telling CS that's not making it back to my desk?"
